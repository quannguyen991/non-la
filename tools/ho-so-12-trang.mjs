...
/* Ảnh trong hồ sơ là ảnh minh hoạ sinh bằng AI, không phải ảnh chụp thực
   địa — và nhãn phải nằm TRÊN ảnh, ở đúng chỗ người đọc nhìn thấy nó.
   Một hồ sơ lấy luận điểm "không trình bày thứ chưa đo như thứ đã đo" mà
   để ảnh vẽ trông như ảnh chụp thì tự phản lại mình. */
figure::before,.bia .hinh::before{content:"Minh hoạ tạo bằng AI";position:absolute;
...
figure::before{top:1.6mm;left:1.6mm}
...
T.push(`<section class="trang">
  ...
  <div class="hai">
    <div>
      ...
      <h3>Từ vấn đề ra yêu cầu</h3>
      <p style="font-size:8.8pt">Mỗi yêu cầu đi thẳng từ một hoàn cảnh có thật của
      người đang đứng ở quầy — không yêu cầu nào đến từ danh sách tính năng.</p>
      <table>
        ...
        <tr><td><b>Ảnh không rời máy</b></td><td>ảnh chụp quán, người, tờ tiền là dữ liệu nhạy cảm</td></tr>
...
T.push(`<section class="trang">
  ...
  <div class="hai">
    ...
    <div>
      ...
      <p><b>Hai lần xuất hỏng im lặng</b>, cả hai bị bắt nhờ đối chiếu ONNX ↔
      PyTorch trên ảnh thật: tệp model văng trọng số ra ngoài còn <b>0,2 MB</b> mà
      vẫn chạy; và lượng tử hoá động <b>sai kết luận 48/48 ảnh</b> — bản tĩnh thay
      thế khác <b>0/48</b>.</p>
    </div>
  </div>
    ...
    <div>
      ...
      <table>
        ...
        <tr class="manh"><td>Ảnh trong hồ sơ này</td>
          <td><b>gpt-image-2</b> — 6 ảnh minh hoạ, <b>không phải ảnh chụp thực địa</b>,
            không nằm trong sản phẩm</td></tr>
      </table>
