...
Bản dựng ngày 12/09/2026 · nhánh `community-v1` · 98 commit · 902 phép thử xanh
...
├── app.js              4.902 dòng — bộ điều phối, dựng giao diện, định tuyến
...
### 16.1 `test.mjs` — 902 phép thử, 0 hỏng
...
612 trong khi bộ thử đã lên 645 (nay là 902).
